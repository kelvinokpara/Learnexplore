      ...
      {useType === "auth" ? (
        ...
        <div id="contact">
          ...
          {type === "textarea" ? (
            ...
            <div className=" block w-full appearance-none rounded-lg border border-gray-300 bg-white px-2.5 pr-3 pb-2.5 pt-4 text-sm text-gray-900 focus:border-2 focus:border-slate-500 focus:outline-none focus:ring-0">
              {icon && useType === "contact" ? (
                <div className="absolute right-1 top-1/2 -translate-y-1/2 bg-white py-1 px-1 text-gray-300 peer-placeholder-shown:text-white peer-focus:text-gray-300">
                  <img src={icon} alt="" />
